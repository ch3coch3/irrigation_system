...
static uint32_t relative_seq=0;
...
extern void make_tcp_ack_with_data_multiple(uint8_t *buf,uint16_t dlen)
{
        uint16_t j;
        // fill the header:
        // This code requires that we send only one data packet
        ...
        relative_seq = relative_seq + (uint32_t)buf[TCP_SEQ_H_P+3] + (((uint32_t)(buf[TCP_SEQ_H_P+2]))<<8) + (((uint32_t)(buf[TCP_SEQ_H_P+1]))<<16) + (((uint32_t)(buf[TCP_SEQ_H_P]))<<24);
        buf[TCP_SEQ_H_P] = (uint8_t)((relative_seq>>24)& 0xff);
        buf[TCP_SEQ_H_P+1] = (uint8_t)((relative_seq>>16)& 0xff);
        buf[TCP_SEQ_H_P+2] = (uint8_t)((relative_seq>>8)& 0xff);
        buf[TCP_SEQ_H_P+3] = (uint8_t)((relative_seq)& 0xff);
...
extern void make_tcp_ack_with_data_end(uint8_t *buf,uint16_t dlen)
{
        uint16_t j;
        // fill the header:
        // This code requires that we send only one data packet
        ...
        relative_seq = relative_seq + (uint32_t)buf[TCP_SEQ_H_P+3] + (((uint32_t)(buf[TCP_SEQ_H_P+2]))<<8) + (((uint32_t)(buf[TCP_SEQ_H_P+1]))<<16) + (((uint32_t)(buf[TCP_SEQ_H_P]))<<24);
        buf[TCP_SEQ_H_P+0] = (uint8_t)((relative_seq>>24)& 0xff);
        buf[TCP_SEQ_H_P+1] = (uint8_t)((relative_seq>>16)& 0xff);
        buf[TCP_SEQ_H_P+2] = (uint8_t)((relative_seq>>8)& 0xff);
        buf[TCP_SEQ_H_P+3] = (uint8_t)((relative_seq)& 0xff);
